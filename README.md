...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/square-math-29ba#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/square-math-29ba
```

A live public deployment of this template is available at [https://square-math-29ba.templates.workers.dev](https://square-math-29ba.templates.workers.dev)
